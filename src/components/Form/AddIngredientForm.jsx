...
const AddIngredientForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      actions: formData.actions
        ? formData.actions.split(",").map((a) => a.trim())
        : [],
      image: base64Image,
    };

    try {
      const res = await axios.post(`${BASEURL}/ingredient/create`, payload);
      ...
      setStatus({ success: false, message: msg, err: err.message });
    }
  };
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold text-gray-800">Add New Ingredient</h2>
